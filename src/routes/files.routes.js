  ...
  res.status(200).json({
    ...
    data: {
      types: [
        ...
        { value: 'purchases', label: 'أوامر الشراء', icon: '🛒' },
 ...
 * @desc    Delete file (Super Admin only)
 * @access  Super Admin
 */
 ...
 * @desc    Delete multiple files (Super Admin only)
 * @access  Super Admin
 */
router.post('/bulk-delete', restrictTo('super_admin'), async (req, res, next) => {
  try {
