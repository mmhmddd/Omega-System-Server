...
async deletePO(id) {
  ...
  /**
 * ✅ NEW: Send Purchase Order PDF by email - Using system credentials with creator info
 */
async sendPOByEmail(poId, userId, userRole, recipientEmail) {
  try {
    ...
    // ✅ Check credentials first (assuming nodemailer is configured like in rfq.service.js)
